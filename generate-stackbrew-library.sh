...
cat <<-EOH
# this file is generated via https://github.com/docker-pkg/docker-qemu/blob/$(fileCommit "$self")/$self

Maintainers: Tianon Gravi <admwiggin@gmail.com> (@docker-pkg)
GitRepo: https://github.com/docker-pkg/docker-qemu.git
EOH
